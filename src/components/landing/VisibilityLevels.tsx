    ...
    <section ref={sectionRef} className="py-16 md:py-24 bg-gradient-to-b from-background to-muted/30 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          {/* Plan Coverage Brackets - Below columns */}
          <div 
            className={`mt-6 transition-all duration-700 delay-500 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
          >
            {/* All brackets stacked from bottom */}
            <div className="flex flex-col gap-1 max-w-[280px] sm:max-w-[360px] md:max-w-[480px] lg:max-w-[560px] mx-auto">
              ...
              <div className="grid grid-cols-4 gap-4 sm:gap-6 md:gap-10">
                <div className="col-span-2 relative flex flex-col items-center">
                  <div className="w-full relative mb-1">
                    <div className="absolute left-0 top-0 w-1 h-2 bg-emerald-400 rounded-b-full" />
                    <div className="absolute right-0 top-0 w-1 h-2 bg-emerald-400 rounded-b-full" />
                    <div className="h-1 bg-emerald-400 rounded-full" />
                  </div>
                  <span className="inline-block bg-emerald-500 text-white text-[8px] sm:text-[9px] md:text-[10px] font-semibold px-1.5 py-0.5 rounded-full whitespace-nowrap">
                    Plan Gratis
                  </span>
                </div>
              ...
              <div className="grid grid-cols-4 gap-4 sm:gap-6 md:gap-10">
                ...
                <div className="col-span-1 relative flex flex-col items-center">
                  <div className="w-full relative mb-1">
                    <div className="absolute left-0 top-0 w-1 h-2 bg-blue-500 rounded-b-full" />
                    <div className="absolute right-0 top-0 w-1 h-2 bg-blue-500 rounded-b-full" />
                    <div className="h-1 bg-blue-500 rounded-full" />
                  </div>
                  <span className="inline-block bg-blue-500 text-white text-[8px] sm:text-[9px] md:text-[10px] font-semibold px-1.5 py-0.5 rounded-full whitespace-nowrap">
                    Plan Pro
                  </span>
                </div>
                <div className="col-span-2" />
              ...
              <div className="grid grid-cols-4 gap-4 sm:gap-6 md:gap-10">
                ...
                <div className="col-span-2 relative flex flex-col items-center">
                  <div className="w-full relative mb-1">
                    <div className="absolute left-0 top-0 w-1 h-2 bg-amber-500 rounded-b-full" />
                    <div className="absolute right-0 top-0 w-1 h-2 bg-orange-500 rounded-b-full" />
                    <div className="h-1 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full" />
                  </div>
                  <span className="inline-block bg-gradient-to-r from-amber-500 to-orange-500 text-white text-[8px] sm:text-[9px] md:text-[10px] font-semibold px-1.5 py-0.5 rounded-full whitespace-nowrap">
                    Pro + Destacados
                  </span>
                </div>
                <div className="col-span-1" />
              ...
              <div className="grid grid-cols-4 gap-4 sm:gap-6 md:gap-10">
                ...
                <div className="col-span-1 relative flex flex-col items-center">
                  <div className="w-full relative mb-1">
                    <div className="absolute left-0 top-0 w-1 h-2 bg-violet-500 rounded-b-full" />
                    <div className="absolute right-0 top-0 w-1 h-2 bg-purple-600 rounded-b-full" />
                    <div className="h-1 bg-gradient-to-r from-violet-500 to-purple-600 rounded-full" />
                  </div>
                  <span className="inline-flex items-center gap-1 bg-gradient-to-r from-violet-500 to-purple-600 text-white text-[8px] sm:text-[9px] md:text-[10px] font-semibold px-1.5 py-0.5 rounded-full whitespace-nowrap">
